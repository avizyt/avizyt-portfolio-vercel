  ...
  return (
    <section id="about-me" className="px-4 md:px-12 lg:px-24 py-16 flex flex-col md:flex-row items-center gap-12">
      <div className="flex-[3]">
        ...
        <div className="mt-8">
            <a 
              href="/cv/Avijit_Biswas_AIML.pdf" 
              target="_blank"
      ...
      <div className="flex-[2] relative hidden md:block">
        <div className="relative z-10 w-full max-w-xs mx-auto">
             <img src="/image/personal.png" alt="Avijit Biswas" className="w-full h-auto border-b border-[#c778dd] grayscale hover:grayscale-0 transition-all duration-500" />
        </div>
